    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(customizer -> customizer.disable())
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .permitAll()
                        .requestMatchers("/api/cases/**").hasAnyAuthority("User", "Surveillance", "Admin", "admin")
                        .requestMatchers("/api/reports/**")
                        .hasAnyAuthority("User", "Surveillance", "legalAdvisor", "AssistantCommissioner",
                                "DirectorIntelligence", "DirectorInvestigation", "Admin", "admin")
                        .requestMatchers("/api/taxpayers/**").hasAnyAuthority("User", "Surveillance", "Admin", "admin")
                        .requestMatchers("/api/informers/**").hasAnyAuthority("User", "Surveillance", "Admin", "admin")

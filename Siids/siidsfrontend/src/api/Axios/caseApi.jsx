...
export const ReportApi = {
    ...
    approveAndRouteByAssistantCommissioner: (reportId, destinationDepartment, signatureBase64, routingNotes = '') => {
        return caseApi.post(`/api/reports/${reportId}/approve-and-route`, {

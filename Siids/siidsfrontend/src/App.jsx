...
const protectedRoutes = [
    ...
    { path: "/intelligence-officer/newCase", element: <NewCase />, permissions: ['CASE_CREATE'] },
    { path: "/intelligence-officer/view-case/*", element: <TaxReportView />, permissions: ['CASE_VIEW'] },
